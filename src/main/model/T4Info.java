...
public class T4Info {
    ...
    public T4Info() {
        ...
        t4Info.put(14, "Employment income \nThe total amount of money that an individual earns from their job, " +
                "including salary, wages, tips, bonuses, and other forms \nof compensation.");
        ...
        t4Info.put(24, "EI (Employment Insurance) insurable earnings" + "\nRefers to the portion of an individual's " +
                "employment income on which they are required to pay EI premiums and may receive \nbenefits in case " +
                "of job loss.");
        ...
        t4Info.put(26, "CPP/QPP pensionable earnings" + "\nRefers to the portion of an individual's employment income on " +
                "which they are required to pay CPP/QPP contributions and \nwhich is used to calculate their future " +
        ...
        t4Info.put(18, "Employee's EI (Employment Insurance) premiums" + "\nThe amounts of money that an individual " +
                "pays from their employment income to contribute towards the EI program, \nwhich provides temporary " +
        ...
        t4Info.put(44, "Union dues" + "\nThe regular payments made by an employee to a labor union as a condition of " +
                "their employment, which are tax-deductible and \nused to support the activities and programs of the " +
                "union.");
        t4Info.put(20, "RPP (Registered Pension Plan) contributions" + "\nThe amounts of money that an individual " +
                "pays towards a pension plan registered with the government, which provides \nretirement income to " +
        ...
        t4Info.put(46, "Charitable donations" + "\nThe amounts of money or property donated by an individual to a " +
                "registered charity or other qualified donee, which can be \nclaimed as a tax credit or deduction on " +
                "their tax return.");
        t4Info.put(52, "Pension adjustment" + "\nA calculation used to determine the amount of contributions an " +
                "individual made to their registered pension plan in a given \nyear and to limit the tax deduction " +
        ...
        t4Info.put(50, "RPP (Registered Pension Plan) or DPSP (Deferred Profit-Sharing Plan) registration number " +
                ...
                "plan or a deferred \nprofit-sharing plan to ensure compliance with tax regulations.");
        t4Info.put(55, "Employee's PPIP (Public Pension Investment Plan) premiums" + "\nThe amounts of money that an " +
                "individual pays from their employment income to contribute towards the PPIP program, which \nprovides " +
        ...
        t4Info.put(56, "PPIP (Public Pension Investment Plan) insurable earnings" + "\nRefers to the portion of an " +
                "individual's employment income on which they are required to pay PPIP premiums and which is used \nto " +
